...
if __name__ == "__main__":
    ...
    if len(frames) > 0:
        ...
        # manj kot izberemo najboljših framov, manjša je zamegljenost, 
        # vendar potrebujemo dovolj slik za glajenje slike oz. zmanjšanje šuma.
        # po parih iteracijah sem ugotovil, da je 10% dober kompromis
